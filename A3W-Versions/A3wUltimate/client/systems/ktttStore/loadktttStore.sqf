...
private ["_ktttshopDialog", "_Dialog", "_playerMoney", "_owner"];
_ktttshopDialog = createDialog "ktttstored";

_Dialog = findDisplay ktttstore_DIALOG;
_playerMoney = _Dialog displayCtrl ktttstore_money;
