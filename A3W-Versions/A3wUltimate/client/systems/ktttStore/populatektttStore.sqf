...
// ******************************************************************************************
//	@file Version: 1.0
//	@file Name: populatektttStore.sqf
...
_itemlisttext = _dialog displayCtrl ktttstore_item_TEXT;
_itemDesc = _dialog displayCtrl ktttstore_item_desc;
...
switch(_switch) do
{
	case 0:
	{
		_itemsArray = call ktttHeadArray;
	};
	case 1:
	{
		_itemsArray = call ktttUniformArray;
	};
	case 2:
	{
		_itemsArray = call ktttVestArray;
	};
	case 3:
	{
		_itemsArray = call ktttBackpackArray;
	};
	case 4:
	{
		_itemsArray = call ktttItemArray;
	};
	case 5:
	{
		_itemsArray = call ktttPlayerItems;
	};
	case 6:
	{
		_itemsArray = call ktttObjectsArray;
		_showPicture = false;
	};
	default
	{
