...
[
	[ // Main colors
		...
		[
			...
			["KTTT Yellow", _texDir + "kttt_camo_yellow.jpg"],
			["KTTT Orange", _texDir + "kttt_camo_orange.jpg"],
			["KTTT Red", 	_texDir + "kttt_camo_red.jpg"],
			["KTTT Pink", 	_texDir + "kttt_camo_pink.jpg"],
			["KTTT Purple", _texDir + "kttt_camo_purple.jpg"],
			["KTTT Blue", 	_texDir + "kttt_camo_blue.jpg"],
			["KTTT Green", 	_texDir + "kttt_camo_green.jpg"],
			["KTTT Grey", 	_texDir + "kttt_camo_grey.jpg"],
			["KTTT Austrian",_texDir + "kttt_camo_austria.jpg"],
			["KTTT German", _texDir + "kttt_camo_germany.jpg"],
			["KTTT Dutch", 	_texDir + "kttt_camo_dutch.jpg"],
			["KTTT Nightly",_texDir + "kttt_camo_night.jpg"]			
		]
	],
	[ // Kart colors
		"Kart_01_Base_F",
	...
	[ // WY-55 Hellcat (Armed) colors
		"I_Heli_light_03_F",
		[
			["KTTT Shark", _texDir + "hellcat\hellcat_shark.jpg"]
		]
	],
	[ // WY-55 Hellcat (Unarmed) colors
...
[
	...
	["Canned Food", "cannedfood", localize "STR_WL_ShopDescriptions_CanFood", "client\icons\cannedfood.paa", 15, 0],
...
//case 0 populatektttStore:
ktttHeadArray = compileFinal str
[
...
//case 1 populatektttStore:
ktttUniformArray = compileFinal str
[
	["Tron Light Suit (Blue)", "U_B_Protagonist_VR", 5000, "uni"],
	["Tron Light Suit (Red)", "U_O_Protagonist_VR", 5000, "uni"],
	["Tron Light Suit (Green)", "U_I_Protagonist_VR", 5000, "uni"]
...
//case 2 populatektttStore:
ktttVestArray = compileFinal str
[
	["Vest (Press)", "V_Press_F", 200, "vest"],
	["Tactical Vest (Police)", "V_TacVest_blk_POLICE", 200, "vest"],
	["Plate Carrier Rig Mk.1", "V_PlateCarrierL_CTRG", 200, "vest"],
	["Plate Carrier Rig Mk.2", "V_PlateCarrierH_CTRG", 200, "vest"]
];

//case 3 populatektttStore:
ktttBackpackArray = compileFinal str
[
	["Carryall (Khaki)", "B_Carryall_khk", 500, "backpack"],
	["Carryall (MTP)", "B_Carryall_mcamo", 500, "backpack"],
	["Carryall (Olive)", "B_Carryall_oli", 500, "backpack"],
...
//case 4 populatektttStore:
ktttItemArray = compileFinal str
[
	["IR Grenade [NATO]", "B_IR_Grenade", 75, "mag"],
	["IR Grenade [CSAT]", "O_IR_Grenade", 75, "mag"],
	["IR Grenade [AAF]", "I_IR_Grenade", 75, "mag"],
	["NV Goggles (Black)", "NVGoggles_OPFOR", 100, "nvg"],
	["NV Goggles (Brown)", "NVGoggles", 100, "nvg"],
	["NV Goggles (Green)", "NVGoggles_INDEP", 100, "nvg"]
];

//case 5 populatektttStore:
ktttPlayerItems = compileFinal str
[
...
//case 6 populatektttStore:
ktttObjectsArray = compileFinal str
[
	["Empty Crate (Small)", "Box_NATO_Wps_F", 200, "ammocrate"],
	["Empty Crate (Medium)", "Box_NATO_WpsSpecial_F", 400, "ammocrate"],
	["Empty Crate (Large)", "Box_NATO_AmmoVeh_F", 800, "ammocrate"],
	["Garage (New)", "Land_i_Garage_V1_F", 1200, "object"],
	["Garage (Old)", "Land_i_Garage_V2_F", 1000, "object"],
	["Fire Place", "Land_FirePlace_F", 25, "object"]
];

//K-TTT Animals
ktttFishItems = compileFinal str
[
...
ktttGoatItems = compileFinal str
[
	["Goat", "goat", "A Goat can ease 75 of your Hunger.", "client\icons\animals\animal_goat.paa", 16, 8]
];

ktttSheepItems = compileFinal str
[
	["Sheep", "sheep", "A Sheep can ease 80 of your Hunger.", "client\icons\animals\animal_sheep.paa", 16, 8]
];

allAnimalItems = compileFinal str (call ktttFishItems + call ktttRabbitItems + call ktttSnakeItems + call ktttTurtleItems + call ktttFowlItems + call ktttDogItems + call ktttGoatItems + call ktttSheepItems);
allPlayerInventoryItems = compileFinal str (call ktttPlayerItems + call customPlayerItems + call allAnimalItems);
allObjectArrays = compileFinal str (call genObjectsArray + call ktttObjectsArray);
